    ...
    if (existingLevel) {
      await levelRepository.update(
        { value: levelData.value },
        {
          ...
          engagementLossRate: levelData.engagementLossRate,
